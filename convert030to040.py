#!/usr/bin/env python
"""
Convert pyContacts v0.3.0 CSV's to new python v0.3.1 CSV format
...
for row in old_contacts_array:
    ...
    lname = old_contacts_array[counter][1]
    number = old_contacts_array[counter][2]
    email = old_contacts_array[counter][3]
    new_contact = [counter,fname,lname,number,email,"","","","",""]
